...
const procedureDefMutator = {
  ...
  addVarInput_: function(name, argId) {
    ...
    this.appendDummyInput(argId)
        ...
        //.appendField(new Blockly.FieldDropdown([["singed","SIGNED"], ["unsigned","UNSIGNED"]]), "DATA")
        .appendField(new Blockly.FieldDropdown([["int","INT"], ["short","SHORT"], ["long","LONG"],
          ["long long","LLONG"], ["char","CHAR"]]), "TYPE")
...
// Custom ID Checker for Dropdown field value

const procedureType = function() {
  // This is a hack to get around the don't-override-builtins check.
  const mixin = {
    /**
     * Return all variables referenced by this block.
...
Blockly.Extensions.register('procedure_type', procedureType);
